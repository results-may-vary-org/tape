...
// app background var(--color-panel)
// app secondary var(--gray-6)

// Base colors
const base00 = 'var(--color-panel)', // Background
  ...
  base07 = 'var(--color-panel)', // Dark background (gutter)
  // Accent colors
...
const invalid = base08,
  ...
  selectionMatch = 'var(--gray-6)', // Selection match background with transparency
  cursor = base04, // Cursor color
  activeBracketBg = 'var(--accent-5)', // (#39496650) Active bracket background with transparency
  activeBracketBorder = 'var(--accent-9)', // (base0D) Active bracket border
 ...
 */
const tapeDarkTheme = EditorView.theme(
  {
    // Base editor styles
    '&': {
      color: base05,
    ...
    // Matching brackets
    '.cm-matchingBracket': {
      backgroundColor: activeBracketBg + ' !important',
    ...
    '&.cm-focused': {
      outline: 'none',
      boxShadow: `0 0 0 2px ${background}, 0 0 0 1px var(--accent-5)`,
    },
...
export { tapeDark, materialDarkMergeStyles, applyMergeRevertStyles };
