...
const base00 = 'var(--color-panel)', // Background - pure white for clean look
  ...
  base07 = 'var(--color-panel)', // Light background (gutter) - gray 50
...
const invalid = base08,
  ...
  selectionMatch = 'var(--gray-6)', // Selection match background
  cursor = base04, // Cursor color
  activeBracketBg = 'var(--accent-5)', // Active bracket background
  activeBracketBorder = 'var(--accent-9)', // Active bracket border
 ...
 */
const tapeLightTheme = EditorView.theme(
  {
    // Base editor styles
    '&': {
      color: base02,
    ...
    '&.cm-focused': {
      outline: 'none',
      boxShadow: `0 0 0 2px ${background}, 0 0 0 3px var(--accent-5)`,
    },
...
export { tapeLight, materialLightMergeStyles, applyMergeRevertStyles };
